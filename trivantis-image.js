...
function ObjShapeBuildSvg(){
	...
	if(this.hasOuterShadow)
	{
		adjustedWidth = this.w + (1 * Math.abs(xOffset)) + (2 * this.lineWeight) + this.outerShadowBlurRadius;
		adjustedHeight = this.h + (1 * Math.abs(yOffset)) + (2 * this.lineWeight) + this.outerShadowBlurRadius; 
